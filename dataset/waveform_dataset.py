...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        mixture, _ = sf.read(os.path.abspath(os.path.expanduser(mixture_path)))
        clean, _ = sf.read(os.path.abspath(os.path.expanduser(clean_path)))
        if self.mode == "train":
            ...
            return mixture[:,0], clean, filename
        else:
            return mixture[:,0], clean, filename